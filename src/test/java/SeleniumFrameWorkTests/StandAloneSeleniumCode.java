...
public class StandAloneSeleniumCode
{
	public static void main(String[] args)
	{
		/*
		 *  we will write all the selenium code here like we did in earlier sections and then we will convert it to framework
		 *  we have used dependancy for webdriver, no need to setup chromedriver
		 */
		...
		//login
		driver.findElement(By.id("userEmail")).sendKeys("shubh2304@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Shubham@2304");
